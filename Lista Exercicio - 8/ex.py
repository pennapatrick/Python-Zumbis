...
def prep(texto):
    contador = 0
    for k in texto:
        if (k[0] in tipo_zmb) and (k[-1] in tipo_outras):
            contador += 1
...
def verbo(texto):
    ...
    contador1p = 0
    for k in texto:
        if (len(k) == 7) and (k[-1] in tipo_outras):
            contador += 1
        if (len(k) == 7) and (k[-1] in tipo_outras) and (k[0] in tipo_outras):
            contador1p += 1
